...
const createService = async (payload, user) => {
...
//& GET MY SERVICES
const getMyServices = async (query, user) => {
...
//& GET ALL SERVICES
const getALLServices = async (query, user) => {
    const sort = query.sortBy ? query.sortBy : "createdAt";
    const order = query.sortOrder ? query.sortOrder : "desc";
    const page = Number(query.page || 1);
    const limit = Number(query.limit || 9);
...
//& REVIEW AND ASSIGN
const reviewService = async (serviceId, user) => {
